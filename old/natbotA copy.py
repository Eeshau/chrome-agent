...
if (
	...
	i = input()
	objective = f"delivery order ONLY a medium cheese pizza from {i} to 151 Charles St W Suite 100, Kitchener, ON N2G 1H6. Address Type is a house. Street Address is 151 Charles St W Suite 100. City is Kitchener. Provience is ON. Postal code is N2G 1H6. Ignore or exit all other popups about subscribing or special deals, it might help you in ignoring these popups to consider the elements in relation to one another; an elements with adjacent ids might provide important context to what the element does in relation to the whole page. the output should exclusively be the [action] [id] . "
	if len(i) > 0:
		pizza_place = i
